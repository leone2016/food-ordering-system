...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void pay(){
        if(orderStatus != OrderStatus.PENDING){
            throw new OrderDomainException("Order is not not in correct state for pay operation");
        }
    ...
    private void updateFailureMessages(List<String> failureMessages) {
        if(this.failureMessages != null && failureMessages!=null){
            this.failureMessages.addAll((Collection<? extends String>) failureMessages.stream().filter(message -> !message.isEmpty()));
        }
    ...
    private void validateItemsPrice() {
        ...
        if (!price.equals(orderItemsTotal)) {
            throw new OrderDomainException("Total price: $" + price.getAmount() +
                    " is not equals to order items total ");
        }
    }
